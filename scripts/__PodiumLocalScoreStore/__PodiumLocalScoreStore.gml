...
function __PodiumLocalScoreStore(_leaderboardName, _value, _metadataString)
{
    static _system = __PodiumSystem();
    
    var _pending = not _system.__local;
    ...
    if (not is_struct(_offlineRecord))
    {
        ...
        _system.__localData[$ _leaderboardName] = _offlineRecord;
    }
