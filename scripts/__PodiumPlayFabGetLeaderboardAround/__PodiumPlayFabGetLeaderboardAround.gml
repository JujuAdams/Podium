...
function __PodiumPlayFabGetLeaderboardAround(_leaderboardName, _count, _versionOffset, _callback = undefined)
{
    ...
    if (_versionOffset == 0)
    {
        var _result = __PodiumPlayFabGetLeaderboardAroundInternal(_leaderboardName, _count, undefined, _callback);
    }
    else
    {
        ...
        function(_resultJSON)
        {
            ...
            {
                __PodiumPlayFabGetLeaderboardAroundInternal(__leaderboardName, __count, _version + __versionOffset, __callback);
            }
        }));
    }
...
function __PodiumPlayFabGetLeaderboardAroundInternal(_leaderboardName, _count, _version, _callback = undefined)
{
    static _system = __PodiumSystem();
