...
function __PodiumRegisterPSLeaderboardSubmit(_leaderboardID, _callbackFunction)
{
    static _asyncIDMap = __PodiumSystem().__psLeaderboardSubmitMap;
    ...
    {
        __PodiumWarning($"Redefining submit leaderboard ID {_leaderboardID}");
